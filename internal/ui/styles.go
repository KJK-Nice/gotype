...
// Theme is a Serika-family (and friends) color pack.
type Theme struct {
	Name  string
	Bg    string
	Main  string
...
var themes = []Theme{
	{Name: "serika", Bg: "#323437", Main: "#e2b714", Text: "#d1d0c5", Sub: "#646669", Error: "#ca4754", Extra: "#7e2a33", Ghost: "#5c4e12"},
	{Name: "serika light", Bg: "#e1e1e3", Main: "#e2b714", Text: "#323437", Sub: "#aaaeb3", Error: "#ca4754", Extra: "#7e2a33", Ghost: "#e8d48a"},
