...
Login with a **Lightning wallet** (LNURL-auth — Wallet of Satoshi is anonymous and easiest, then Phoenix, Zeus, Breez, Alby, or Blink). Earn XP from races, unlock Season Pass tiers, equip cosmetics (themes, carets, FX), buy consumables with sats.
